...
<div class="content-wrapper">
    ...
    @component('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard']])
        @slot('title') Product Sale Report @endslot
        @slot('add_btn')  @endslot
        @slot('active') Product Sale Report @endslot
    @endcomponent
    <!-- /.content-header -->
    <div class="card mx-5">
    ...
    ['S No.','Product Name','Sale']
    ])
        @slot('table_id') sale_list @endslot
    @endcomponent
</div>
@stop
