...
@component('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','All Products'=>'admin/products']])
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="col-md-9">
                                        <select name="category" class="form-control select2">
                                                @foreach($category as $list)
                                                    <option value="{{$list->id}}" {{($products->category == $list->id) ? 'selected' : ''}}>{{$list->category_name}}</option>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="unit" placeholder="Unit" value="{{$products->unit}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="min_qty" placeholder="Minimum Purchase Qty" value="{{$products->min_qty}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="tokenfield" type="text" class="form-control" name="tags" placeholder="Type and hit enter to add a tag" value="{{$products->tags}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="checkbox">
                                            <input type="checkbox" id="checkbox1" name="refundable" {{ ($products->refundable == "1" ? "checked":"") }}>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <input type="text" hidden name="old_gallery" value="{{$products->gallery_img}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="hidden" class="custom-file-input" name="old_img" value="{{$products->thumbnail_img}}" />
                                        <input type="file" class="custom-file-input" name="thumbnail_img" onChange="readURL(this);">
                                        <label class="custom-file-label">Choose file</label>
                                    </div>
                                    <div class="col-md-2">
                                        @if($products->thumbnail_img != '')
                                            <img id="image" src="{{asset('products/'.$products->thumbnail_img)}}" alt=""  width="100px">
                                        @else
                                            <img id="image" src="{{asset('products/default.png')}}" alt=""  width="100px">
                                        @endif
                                    </div>
                                </div>
                            </div>
                                        ...
                                        @if(!empty($colors))
                                            ...
                                            @foreach($colors as $item)
                                                @if(in_array($item->id,$row_facility))
                                                    <option value="{{$item->id}}" selected>{{$item->color_name}}</option>
                                                @else
                            ...
                            <div class="form-group">
                                <table class="table">
                                    ...
                                    @php $count++; @endphp
                                        ...
                                        <input type="hidden" name="attribute_id" value="{{$value->attribute_id}}">
                                        <tr class="attrcount">
                                            <td>
                                                <select name="attribute[]" id="attribute" class="form-control attribute-select">
                                                    @if(!empty($attribute))
                                                        ...
                                                        @php $selected = ($item->id == $value->attribute_id) ? 'selected' : ''; @endphp
                                                            <option value="{{$item->id}}" data-attribute="{{$item->id}}" {{$selected}}>{{$item->title}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </td>
                                            <td>
                                                <select class="form-control attrvalue-select select2" name="attrvalue{{$count}}[]"  id="attrvalue" multiple>
                                                    @if(!empty($attrvalues))
                                                        @foreach($attrvalues as $item1)
                                                        @php $selected = ($item1->attribute == $value->attribute_id) ? 'selected' : ''; @endphp
                                                            <option value="{{$item1->id}}" {{$selected}}>{{$item1->value}}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                            </td>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="unit_price" placeholder="Unit Price" value="{{$products->unit_price}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                        ...
                                        <select class="form-control tax" name="tax" id="">
                                            ...
                                            @foreach($tax as $item)
                                                @if($products->tax == $item->id)
                                                    <option value="{{$item->id}}" data-percent="{{$item->percent}}" selected>{{$item->percent}}%</option>
                                                @else
                                                    @if($item->status == '1')
                                                        <option value="{{$item->id}}" data-percent="{{$item->percent}}">{{$item->percent}}%</option>
                                                    @endif
                                                @endif
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group taxable_price">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="taxable_price" placeholder="Taxable Price" value="{{$products->taxable_price}}" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="quantity" placeholder="Quantity" value="{{$products->quantity}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="datefilter" placeholder="Select Date" value="{{$products->date_range}}">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="number" class="form-control" name="discount" placeholder="Discount" value="{{$products->discount}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <select class="form-control" name="discount_type" id="">
                                            <option value="flat" {{ ($products->discount_type == "flat" ? "selected":"") }}>Flat</option>
                                            <option value="percent" {{ ($products->discount_type == "percent" ? "selected":"") }}>Percent</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="meta_title" placeholder="Meta Title" value="{{$products->meta_title}}">
                                    </div>  
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="meta_desc" placeholder="Meta Description" id="" cols="30" rows="4">{{$products->meta_desc}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" name="product_status"  style="width: 100%;">
                                            <option value="1" {{ ($products->status == "1" ? "selected":"") }}>Published</option>
                                            <option value="0" {{ ($products->status == "0" ? "selected":"") }}>Draft</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="checkbox">
                                            <input type="checkbox" id="checkbox2" name="show_qty" {{ ($products->show_quantity == "1" ? "checked":"") }}>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="checkbox">
                                            <input type="checkbox" id="checkbox5" name="today_deal" {{ ($products->today_deal == "1" ? "checked":"") }}>
                        ...
                        <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <select class="form-control" name="shipping_charges" id="">
                                            <option value="free" {{ ($products->shipping_charges == "free" ? "selected":"") }}>Free Shipping</option>
                                            <option value="area" {{ ($products->shipping_charges == "area" ? "selected":"") }}>Area Wise</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" class="form-control" name="shipping_days" placeholder="Shipping Days" value="{{$products->shipping_days}}">
                                    </div>
                                </div>
                            </div>
                        </div>
...
for($i=0;$i<count($gallery);$i++){
    $g = (object) array('id'=>$i+1,'src'=>asset('products/'.$gallery[$i]));
            ...
            '<td>'+
                '<select name="attribute[]" id="attribute" class="form-control attribute-select" data-attr_value="'+count+'">'+
                    ...
                    <?php foreach($attribute as $item){ ?>
                        '<option value="{{$item->id}}" data-attribute="{{$item->id}}">{{$item->title}}({{$item->category_name}})</option>'+
                    <?php }?>
                '</select>'+
            '</td>'+
            '<td>'+
