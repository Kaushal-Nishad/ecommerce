...
@component('admin.components.content-header',['breadcrumb'=>['Dashboard'=>'admin/dashboard','All Brand'=>'admin/payment-method']])
    @slot('title') Add Payment Method @endslot
    @slot('add_btn')  @endslot
    @slot('active') Add Payment Method @endslot
@endcomponent
<!-- Main content -->
<section class="content card">
    <div class="container-fluid card-body">
        <!-- form start -->
        <form class="form-horizontal" id="add_payment_method"  method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <!-- left column -->
                <div class="col-md-12">
                   <input type="hidden" class="url" value="{{url('admin/payment-method')}}" >
                    <!-- jquery validation -->
                    <div class="card">
