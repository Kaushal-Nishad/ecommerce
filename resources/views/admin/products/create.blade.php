                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="unit" placeholder="Unit (eg.  KG, pc etc.)">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control" name="min_qty" value="1" placeholder="Minimum Purchase Qty">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" class="form-control unit-price" name="unit_price" placeholder="Unit Price">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="datefilter" placeholder="Select Date">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <textarea class="form-control" name="meta_desc" placeholder="Meta Description" id="" cols="30" rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <input type="number" class="form-control" name="shipping_days" placeholder="Shipping Days">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).on('change','.tax',function(){
        ...
        var row = '<div class="row">'+
                        ...
                        '</div>'+
                        '<div class="col-md-9">'+
                            '<input type="number" class="form-control" name="taxable_price" placeholder="Taxable Price" value="'+total+'" disabled>'+  
                        '</div>'+
                '</div>';
